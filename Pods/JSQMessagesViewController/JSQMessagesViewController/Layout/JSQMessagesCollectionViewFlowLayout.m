...
- (void)prepareLayout
{
    ...
    if (self.isInsertingCellsToTop == YES) {
        CGSize oldContentSize = self.contentSizeWhenInsertingToTop;
        CGSize newContentSize = self.collectionViewContentSize;
        CGFloat contentOffsetY = self.collectionView.contentOffset.y + (newContentSize.height - oldContentSize.height);
        CGPoint newOffset = CGPointMake(self.collectionView.contentOffset.x, contentOffsetY);
        [self.collectionView setContentOffset:newOffset animated:NO];
        
        self.contentSizeWhenInsertingToTop = CGSizeZero;
